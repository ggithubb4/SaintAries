...
"https://te.legra.ph/file/029433942ed25fde9dacb.png",
"https://te.legra.ph/file/9120fea1364c76da3b452.png",
"https://te.legra.ph/file/6109fe2dac060b66ff007.png",
"https://te.legra.ph/file/750be5a875acf24337957.png",
"https://te.legra.ph/file/4506bddc905d1503983d4.png",
"https://te.legra.ph/file/f1a31557b63b1e0169d51.png",
"https://te.legra.ph/file/134d9b2ae1b236d55fb13.png",
...
DONATE_STRING = """Hello, glad to hear you want to donate!
 But we dont accept any donations
 You can support the project via [Sharing my channel](https://t.me/share/url?url=https://t.me/check_this_channel)
"""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            k = message.reply_sticker("CAACAgIAAxkBAAEFCN5iqB011-1UhrDKx0UObzOJ8Znx_gACIFYAAp7OCwABulJc1fwJZ28kBA")
            asyncio.sleep(4)
            k.delete()
            message.reply_photo(
                random.choice(PICS),
...
def aries_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"*👋Hi again!  The name's {dispatcher.bot.first_name}  \n\nA powerful bot built to help you manage your group and provide movies easily.* "
            f"\n\n 🔥 Join My [Official Channel](https://t.me/international_free_movies) 🔥"
            ...
            f"\n\n👇 You Can Know More About *Rocket* By Clicking The Below Buttons 👇",
            parse_mode=ParseMode.MARKDOWN,
        ...
        query.message.edit_text(
            text=f"*Rocket Is just the redisigned version of Daisy and Saitama And Othrer for the best performance.*",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n📌 **This function crashes frequently. We recommend not to use!**\n"
            f"\n⚡ Powered by @free_music123 \n",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@check_this_channel", "⚡️")
        except Unauthorized:
            LOGGER.warning(
